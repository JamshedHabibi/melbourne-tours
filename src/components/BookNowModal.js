						...
						<Modal
							...
							trigger={
								<Button
									icon="check"
									content="Book"
									className="book-now-modal-book-button"
									onClick={value.bookTour}
								/>
							}>
						...
						<Modal
							...
							trigger={
								<span
									...
									onClick={value.handleBookNowModalOpen}>
							...
							<Modal.Content image>
								<Image
									wrapped
									size="large"
									src={value.selectedTourToView.images[0].source_url}
								/>
								<Modal.Description>
									...
									<div>
										<span
											className="participant-number-btn"
											onClick={value.decrementParticipantCount}>
											-
										</span>
										<span className="participant-number-btn">
											{value.tourParticipantCount}
										</span>
										<span
											className="participant-number-btn"
											onClick={value.incrementParticipantCount}>
											+
										</span>
									</div>
								</Modal.Description>
